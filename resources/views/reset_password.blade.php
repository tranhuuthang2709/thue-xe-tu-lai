                ...
                <div class="login-auth">
                    <div class="login-auth-wrap">
                        <div class="sign-group">
                            <a href="index-2.html" class="btn sign-up">
                                <span><i class="fe feather-corner-down-left" aria-hidden="true"></i></span> Quay lại
                            </a>
                        </div>
                        <h1>Xin chào {{ $user->last_name }}</h1>
                        <p class="account-subtitle">Vui lòng tạo mật khẩu để đăng nhập cho lần tiếp theo</p>
                        <form action="" method="POST">
                            ...
                            @endif
                            <button type="submit" class="btn btn-outline-light w-100 btn-size mt-1">Lưu lại</button>
                        </form>
                    </div>
                </div>
            </div>
